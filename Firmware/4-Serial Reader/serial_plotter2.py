# -*- coding: utf-8 -*-
"""
Created on Fri Mar  28 10:03:43 2022

@author: Chathura Jayasankha
"""
...
def main():
    ...
    ax.set_title('fNIRS readings')
    ax.set_xlabel("Time")
    ax.set_ylabel("Output")

    lineLabel = ['Oxihemoglobin', 'Deoxyhemoglobin', 'extra']
    style = ['r-', 'b-', 'c-']  # linestyles for the different plots
